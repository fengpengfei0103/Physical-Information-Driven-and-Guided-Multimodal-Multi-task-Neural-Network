    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 100 == 0:
            ...
            save_mode_path = os.path.join(snapshot_path,
                                          'PINNMutilModelUnetStability_epoch_' +
                                          str(epoch + 1) + '.pth')
...
if __name__ == '__main__':
    ...
    # file_path0075 = '../dataset/0075/0075.xlsx'
    # file_path0100 = '../dataset/0100/0100.xlsx'
    # file_path0125 = '../dataset/0125/0125.xlsx'
    # file_path0150 = '../dataset/0150/0150.xlsx'
    file_path0175 = '../dataset/0175/0175.xlsx'
    # file_path0200 = '../dataset/0200/0200.xlsx'
    ...
    rtest_model(
        ...
        model_path='model_snapshot/PINNMutilModelUnetStability_epoch_100.pth',
        output_dir='MutilControl结果图像0175'
    )